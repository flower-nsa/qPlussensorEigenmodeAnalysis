% --- 基本パラメータの設定 ---
% 探針長さを固定 (3 mm)
startl_point_end_l = 0.5e-3:0.01e-3:5.00e-3;%探針の長さ(m) 初期値：間隔：終了値
...
for i = 2:N_points
    ...
    if prev_sign ~= 0 && curr_sign ~= 0 && curr_sign ~= prev_sign
        ...
        if length(roots_found) == 5 %いくつ調べるか
            break;
        end
    end
    prev_sign = curr_sign;
...
f_fre_4 = roots_found(4);
f_fre_5 = roots_found(5);
...
fprintf('f_fre_4: %.8f Hz\n', f_fre_4);
fprintf('f_fre_5: %.8f Hz\n', f_fre_5);
%ここまで共振周波数の計算
% f_fre_1 に対して X を求める
...
% f_fre_4 に対して
[M3x3_4, B4] = compute_M3x3_and_B(f_fre_4,param);
X4 = M3x3_3 \ B4;
%disp('X4 ='); disp(X3);

% f_fre_5 に対して
[M3x3_5, B5] = compute_M3x3_and_B(f_fre_5,param);
X5 = M3x3_3 \ B5;
%disp('X5 ='); disp(X3);
...
% f_fre_4 に対してk_eff_v,k_eff_l,Angleを求める
[k4_eff_v, k4_eff_l,angle4,dw_le_4,dw1_4,dw2_4] = compute_k_theta(X4(1),X4(2),X4(3),X4(4),X4(5),f_fre_4,param);
...
% f_fre_5 に対してk_eff_v,k_eff_l,Angleを求める
[k5_eff_v, k5_eff_l,angle5,dw_le_5,dw1_5,dw2_5] = compute_k_theta(X5(1),X5(2),X5(3),X5(4),X5(5),f_fre_5,param);
...
results = [results; double([param.l*1e3, f_fre_1, k1_eff_v, k1_eff_l,angle1, X1(1),X1(2), ...
    ...
    X3(3),X3(4),X3(5),dw_le_3,dw1_3,dw2_3,f_fre_4, k4_eff_v, k4_eff_l,angle4,X4(1),X4(2),...
    X4(3),X4(4),X4(5),dw_le_4,dw1_4,dw2_4,f_fre_5, k5_eff_v, k5_eff_l,angle5,X5(1),X5(2),...
    X5(3),X5(4),X5(5),dw_le_5,dw1_5,dw2_5])];  % 単位:mm, Hz
...
T = array2table(results, 'VariableNames', {'l_mm', 'f1_Hz', 'k1_eff_v', 'k1_eff_l','angle1','X1(1)','X1(2)', ...
    ...
    'X3(3)','X3(4)','X3(5)','dw_le_3','dw1_3','dw2_3','f4_Hz','k4_eff_v', 'k4_eff_l','angle4','X4(1)','X4(2)', ...
    'X4(3)','X4(4)','X4(5)','dw_le_4','dw1_4','dw2_4','f5_Hz','k5_eff_v', 'k5_eff_l','angle5','X5(1)','X5(2)', ...
    'X5(3)','X5(4)','X5(5)','dw_le_5','dw1_5','dw2_5',});
disp(T);
writetable(T, 'qPlus_eigenmode_analysis.csv');
